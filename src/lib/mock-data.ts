...
// Campaign Data with full details
import type {
  Campaign,
  CampaignPerformance,
  ReportTemplate,
...
const generatePerformanceData = (days: number, baseSpend: number, baseConversions: number): CampaignPerformance[] => {
  ...
  for (let i = days; i >= 0; i--) {
    ...
    data.push({
      ...
      spend,
      conversions,
      revenue: Math.round(spend * (4 + Math.random() * 3)),
      impressions: Math.round(spend * (80 + Math.random() * 40)),
      clicks: Math.round(spend * (4 + Math.random() * 2)),
    });
  }
  return data;
};
...
export const campaignsData: Campaign[] = [
  {
    id: "camp-001",
    name: "Nike Spring Collection 2026",
    status: "active",
    channel: "Google Ads",
    budget: 50000,
    spent: 38420,
    ...
    endDate: "2026-04-30",
    performance: generatePerformanceData(30, 1280, 95),
  },
  {
    id: "camp-002",
    name: "Apple Watch Series 12 Launch",
    status: "active",
    channel: "Meta",
    budget: 75000,
    spent: 52180,
    ...
    endDate: "2026-05-15",
    performance: generatePerformanceData(30, 1740, 64),
  },
  {
    id: "camp-003",
    name: "Spotify Premium Family Q1",
    status: "active",
    channel: "Google Ads",
    budget: 35000,
    spent: 28750,
    ...
    endDate: "2026-03-31",
    performance: generatePerformanceData(30, 958, 143),
  },
  {
    id: "camp-004",
    name: "Tesla Model Y Spring Promo",
    status: "active",
    channel: "LinkedIn",
    budget: 120000,
    spent: 89500,
    ...
    endDate: "2026-06-30",
    performance: generatePerformanceData(30, 2983, 5),
  },
  {
    id: "camp-005",
    name: "Starbucks Rewards Acquisition",
    status: "active",
    channel: "Meta",
    budget: 45000,
    spent: 41200,
    ...
    startDate: "2026-02-01",
    endDate: "2026-03-31",
    performance: generatePerformanceData(30, 1373, 282),
  },
  {
    id: "camp-006",
    ...
    endDate: "2026-02-28",
    performance: generatePerformanceData(30, 2080, 11),
  },
  {
    id: "camp-007",
    name: "Amazon Prime Day Early Access",
    status: "ended",
    channel: "Google Ads",
    budget: 200000,
    spent: 198500,
    ...
    endDate: "2025-10-15",
    performance: generatePerformanceData(14, 14178, 1771),
  },
  {
    id: "camp-008",
    name: "Netflix Games Mobile Campaign",
    status: "active",
    channel: "TikTok",
    budget: 60000,
    spent: 34800,
    ...
    endDate: "2026-04-20",
    performance: generatePerformanceData(30, 1160, 413),
  },
  {
    id: "camp-009",
    name: "Salesforce Dreamforce 2026 Promo",
    status: "draft",
    channel: "LinkedIn",
    budget: 150000,
    spent: 0,
  ...
  },
  {
    ...
    endDate: "2026-05-31",
    performance: generatePerformanceData(30, 607, 108),
  },
  {
    id: "camp-011",
    name: "Uber Eats Restaurant Week",
    status: "active",
    channel: "Meta",
    budget: 40000,
    spent: 28900,
    ...
    startDate: "2026-03-01",
    endDate: "2026-03-15",
    performance: generatePerformanceData(14, 2064, 1300),
  },
  {
    id: "camp-012",
    name: "Microsoft 365 SMB Outreach",
    status: "paused",
    channel: "Google Ads",
    budget: 55000,
    spent: 42300,
    ...
    startDate: "2026-01-15",
    endDate: "2026-04-15",
    performance: generatePerformanceData(30, 1410, 30),
  },
];
...
export const reportTemplates: ReportTemplate[] = [
  {
    ...
    description: "Overview of all campaign KPIs including spend, conversions, and ROAS for the past week",
    type: "weekly_summary",
    icon: "BarChart3",
  ...
  },
  {
    ...
    description: "Side-by-side analysis of performance metrics across all marketing channels",
  ...
  },
  {
    ...
    description: "Track budget allocation, spend rates, and remaining budget by campaign",
  ...
  },
  {
    ...
    description: "Detailed metrics for individual campaigns with trend analysis and recommendations",
  ...
  },
  {
    ...
    description: "Track user journey from impression to conversion with drop-off analysis",
...
export const generatedReports: GeneratedReport[] = [
  {
    id: "gen-001",
    templateId: "rpt-001",
    name: "Weekly Performance Summary - Mar 4-10, 2026",
  ...
  },
  {
    id: "gen-002",
    templateId: "rpt-003",
    name: "Budget Utilization - March 2026",
    generatedAt: "2026-03-11T09:30:00Z",
    dateRange: { start: "2026-03-01", end: "2026-03-11" },
    format: "xlsx",
    size: "1.1 MB",
    downloadUrl: "#",
  },
  {
    id: "gen-003",
    templateId: "rpt-002",
    name: "Channel Comparison Q1 2026",
    generatedAt: "2026-03-08T14:00:00Z",
    dateRange: { start: "2026-01-01", end: "2026-03-08" },
    format: "pdf",
    size: "4.8 MB",
    downloadUrl: "#",
  },
  {
    id: "gen-004",
    templateId: "rpt-001",
    name: "Weekly Performance Summary - Feb 26 - Mar 3, 2026",
    generatedAt: "2026-03-03T08:00:00Z",
    dateRange: { start: "2026-02-26", end: "2026-03-03" },
    format: "pdf",
    size: "2.2 MB",
    downloadUrl: "#",
  },
  {
    id: "gen-005",
    templateId: "rpt-005",
    name: "Conversion Funnel - February 2026",
...
export const notificationsData: Notification[] = [
  {
    ...
    message: "Nike Spring Collection campaign has reached 90% of allocated budget",
    timestamp: "5 minutes ago",
    read: false,
    actionUrl: "/dashboard/campaigns?id=camp-001",
  ...
  },
  {
    ...
    message: "Weekly Performance Summary is ready for download",
  ...
  },
  {
    ...
    message: "Google Analytics sync is running 30 minutes behind schedule",
    timestamp: "2 hours ago",
    read: false,
    actionUrl: "/dashboard/connectors",
  ...
  },
  {
    ...
    message: "AI detected a potential optimization opportunity in Meta campaigns",
  ...
  },
  {
    ...
    message: "Uber Eats Restaurant Week campaign is now live",
    timestamp: "5 hours ago",
    read: true,
  },
  {
    id: "notif-006",
    type: "alert",
    title: "ROAS dropped below target",
    message: "Microsoft 365 SMB Outreach ROAS fell to 3.8x (target: 4.5x)",
    timestamp: "8 hours ago",
    read: true,
    actionUrl: "/dashboard/campaigns?id=camp-012",
    actionLabel: "Review",
  },
  {
    id: "notif-007",
    ...
    message: "Your weekly marketing performance digest is available",
    timestamp: "1 day ago",
    read: true,
  },
  {
    ...
    message: "Approaching daily API rate limit (85% used)",
    timestamp: "1 day ago",
    read: true,
  },
];
...
export const userSettings: UserSettings = {
  email: "demo@analyticspro.io",
  name: "Demo User",
  company: "Analytics Pro Demo",
...
export const apiKeys: ApiKey[] = [
  {
    ...
    lastUsed: "2026-03-13",
    permissions: ["read", "write", "campaigns", "reports"],
  },
  {
    id: "key-002",
...
export const integrations: Integration[] = [
  {
    ...
    connected: true,
    lastSync: "5 minutes ago",
    accountName: "Analytics Pro - Production",
  },
  {
    id: "int-002",
    name: "Google Ads",
  ...
  },
  {
    ...
    connected: true,
    lastSync: "12 minutes ago",
    accountName: "analytics-pro-prod",
  },
];
